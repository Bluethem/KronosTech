<script lang="ts">
	...
	import { Heart, Grid3x3, List, Sparkles } from 'lucide-svelte';
...
<svelte:head>
	<title>Novedades - KronosTech</title>
	<meta name="description" content="Los productos más recientes y nuevos lanzamientos en KronosTech" />
</svelte:head>
	...
	<nav class="flex mb-6 text-sm">
		<ol class="inline-flex items-center space-x-2">
			...
			<li class="flex items-center">
				...
				<span class="text-text-light dark:text-text-dark font-medium">Novedades</span>
			</li>
		</ol>
	</nav>
	...
	<div class="grid grid-cols-1 lg:grid-cols-4 gap-8">
		...
		<aside class="lg:col-span-1 hidden lg:block">
			<div class="sticky top-24 max-h-[calc(100vh-7rem)] overflow-y-auto pr-2 pb-4">
				...
				<div class="space-y-6">
					<!-- Nuevo Badge -->
					<div class="bg-gradient-to-br from-purple-500/10 to-pink-500/10 dark:from-purple-500/20 dark:to-pink-500/20 rounded-lg p-4 border border-purple-500/30">
						<div class="flex items-center gap-2 text-purple-600 dark:text-purple-400">
							<Sparkles size={20} />
							<span class="font-bold text-sm">Novedades</span>
						</div>
						<p class="text-xs text-slate-600 dark:text-slate-400 mt-2">
							Últimos lanzamientos y productos nuevos
						</p>
					</div>
		...
		<div class="lg:col-span-3">
			...
			<div class="mb-6">
				<div class="flex items-center gap-3 mb-2">
					<Sparkles size={32} class="text-purple-600 dark:text-purple-400" />
					<h1 class="text-3xl md:text-4xl font-black tracking-tight">Novedades</h1>
				</div>
				<p class="text-slate-600 dark:text-slate-400">
					Descubre los últimos lanzamientos y productos más recientes en tecnología
				</p>
			</div>
			...
			<div class="flex flex-wrap items-center justify-between gap-4 p-4 mb-6 rounded-lg border border-border-light dark:border-border-dark">
				<div class="flex items-center gap-4">
					<p class="text-sm text-slate-600 dark:text-slate-400">
						<span class="font-bold text-purple-600 dark:text-purple-400">{totalProductos}</span> novedades
					</p>
				</div>
			...
			{:else if productos.length === 0}
				<div class="text-center py-20">
					<Sparkles size={64} class="mx-auto text-slate-400 mb-4" />
					<h3 class="text-xl font-bold mb-2">No hay novedades disponibles</h3>
